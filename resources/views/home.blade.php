        ...
        <div class="container position-static">
            <div class="row align-items-center h-100">
                ...
                <div class="col-lg-7">
                    ...
                    <a class="btn btn-xl btn-round btn-success w-220 mr-3 px-6 d-none d-md-inline-block" href="#section-demo">@lang('pages.home.Explore Our Products')</a>
                    <a class="btn btn-xl btn-round btn-outline-light w-220 px-6" href="#section-values">@lang('pages.home.Explore Our Values')</a>
                </div>
